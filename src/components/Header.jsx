...
navigate(`results?seacrh_query=${text} `);
  };
  ...
  <header className='p-4 flex justify-between items-center'>
    ...
    <div className='flex gap-3 text-xl'>
        <FaBell className='cursor-pointer hover:text-gray-400 duration-150-[250ms]'/>
        <IoIosVideocam className='cursor-pointer hover:text-gray-400 duration-150-[250ms]' />
        <MdVideoLibrary className='cursor-pointer hover:text-gray-400 duration-150-[250ms]'/>
    </div>
  </header>
  )
}
